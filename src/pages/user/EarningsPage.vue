...
const breakdownData = ref([
  { source: 'Book Sales', amount: 8420.00, percentage: 67.5 },
  { source: 'Premium Chapters', amount: 2150.00, percentage: 17.3 },
  { source: 'Sponsorships', amount: 980.50, percentage: 7.9 },
  { source: 'Donations', amount: 900.00, percentage: 7.2 },
])
...
const topBooks = ref([
  {
    ...
    earnings: 3420.50,
    rating: 4.8,
    image: 'https://images.unsplash.com/photo-1507842217343-583f2270dba5?q=80&w=400',
  },
  {
    id: 2,
    ...
    earnings: 2150.00,
    rating: 4.6,
    image: 'https://images.unsplash.com/photo-1516979187457-636afe6537c1?q=80&w=400',
  },
  {
    id: 3,
    ...
    earnings: 1890.25,
    rating: 4.5,
    image: 'https://images.unsplash.com/photo-1504995617519-4058a7d8f6c4?q=80&w=400',
  },
])
        ...
        <div class="p-3 sm:p-4 lg:p-6">
          ...
          <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 sm:mb-8 gap-3 sm:gap-4">
            <div class="w-full sm:w-auto">
              <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-1 sm:mb-2">Earnings Dashboard</h1>
              <p class="text-gray-600 text-[12px] sm:text-[13px] lg:text-sm">Track your earnings and performance metrics</p>
            </div>
            <button
