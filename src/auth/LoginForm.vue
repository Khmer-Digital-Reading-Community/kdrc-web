    ...
    >
      ...
      >
        ...
        <div>
          ...
          <h1
            class="text-[2.6rem] leading-[1.1] font-serif font-bold text-[#4b900e] mb-6"
            style="
              font-family:
          ...
          <p class="text-[#a99278] text-sm leading-relaxed max-w-[280px]">
            Join our community of book lovers and discover timeless stories,
            cultural heritage, and modern literature in one elegant space.
          </p>
        </div>
          ...
          <form @submit.prevent="handleLogin" novalidate class="space-y-5">
            ...
            <div class="flex items-center justify-between">
              <label class="flex items-center gap-2.5 cursor-pointer group">
                ...
                <span
                  class="text-[#666666] text-xs group-hover:text-[#333333] transition-colors"
                  >Remember me for 30 days</span
                >
              </label>
              <a
                href="/forgot-password"
                class="text-xs text-[#666666] hover:text-[#c8862a] transition-colors duration-150"
              >
                Forgot password?
              </a>
            </div>
            ...
            <div class="relative flex items-center gap-3 py-1">
              ...
              <span
                class="text-[10px] uppercase tracking-[0.2em] text-[#999999]"
