<template>
    <div>
        ...
        >
            <!-- Top: Logo + Hamburger -->
            <div
                class="flex items-center justify-between px-4 py-5 border-b border-[#e0dbd0]"
            >
                <div class="flex items-center gap-2 overflow-hidden">
                    <div
                        class="flex-none w-7 h-7 bg-[#1c3a2e] rounded-md flex items-center justify-center"
                    >
                        <svg
            ...
            <!-- Nav Sections -->
            <nav
                class="flex-1 overflow-y-auto overflow-x-hidden py-4 flex flex-col gap-5"
            >
                <div v-for="section in navSections" :key="section.group">
                    ...
                    <div
                        v-else
                        class="border-t border-[#e0dbd0] mx-3 mb-2"
                    ></div>
                        ...
                        <li v-for="item in section.items" :key="item.label">
                            ...
                            >
                                ...
                                <div
                                    ...
                                    class="absolute left-full ml-3 px-2.5 py-1.5 bg-[#1c3a2e] text-white text-[12px] font-semibold rounded-lg whitespace-nowrap opacity-0 pointer-events-none group-hover:opacity-100 transition-opacity duration-200 z-50 shadow-lg"
                                >
                                    {{ item.label }}
                                    <span
                                        class="absolute right-full top-1/2 -translate-y-1/2 border-4 border-transparent border-r-[#1c3a2e]"
                                    ></span>
                                </div>
                            </button>
                        </li>
...
export default {
    ...
    methods: {
        ...
        createNewDraft() {
            this.mobileOpen = false;
            if (this.$route.path !== "/dashboard/books/new") {
